...
},{"symbol-observable":"node_modules/symbol-observable/es/index.js"}],"src/03_ApplyMiddleware.js":[function(require,module,exports) {
"use strict";

var _redux = require("redux");

console.log("-------------------03_ApplyMiddleware.js-----------------------");
...
var monitorEnhancer = function monitorEnhancer(createStore) {
  return function (reducer, initialState, enhancer) {
    var monitorReducer = function monitorReducer(state, action) {
...
var logEnhancer = function logEnhancer(createStore) {
  return function (reducer, initialState, enhancer) {
    var loggedReducer = function loggedReducer(state, action) {
      console.log("Old-State", state, action);
      var newState = reducer(state, state);
...
var store = (0, _redux.createStore)(reducer, (0, _redux.compose)(monitorEnhancer, logEnhancer));
store.dispatch({
  type: "Hello"
});
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/03_ApplyMiddleware.js"], null)
//# sourceMappingURL=/03_ApplyMiddleware.597d21f2.js.map