...
},{"symbol-observable":"node_modules/symbol-observable/es/index.js"}],"src/04_Middleware.js":[function(require,module,exports) {
"use strict";

var _redux = require("redux");

console.log("-------------------04_Middleware.js-----------------------"); // middleware and enhancer both are same but middleware are used in general
...
var monitorMiddleware = function monitorMiddleware(store) {
  return function (next) {
    return function (action) {
...
var store = (0, _redux.createStore)(reducer, (0, _redux.applyMiddleware)(logMiddleware, monitorMiddleware));
store.dispatch({
  type: "Hello"
});
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/04_Middleware.js"], null)
//# sourceMappingURL=/04_Middleware.8cfc9d21.js.map